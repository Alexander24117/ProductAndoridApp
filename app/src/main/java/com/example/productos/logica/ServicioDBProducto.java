...
public class ServicioDBProducto extends SQLiteOpenHelper {
    ...
    public boolean InsertarCategorias() {
        ...
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Aseo Corporal");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 3);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Aseo Hogar");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 4);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Comida Empaquetada");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 5);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Comida Enlatada");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 6);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Frutas");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 7);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Utiles Escolares");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 8);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Verduras");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);

        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CODIGO, 9);
        contentValues.put(NOMBRE_ATRIBUTO_CATEGORIAS_CATEGORIA, "Otros");
        resultado = db.insert(NOMBRE_TABLA_CATEGORIAS, null, contentValues);
